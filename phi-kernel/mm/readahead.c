		...
		pgoff_t offset, unsigned long nr_to_read)
{
	...
	while (nr_to_read) {
#ifdef CONFIG_AGGRESSIVE_READAHEAD
		unsigned long this_chunk = (VM_MAX_READAHEAD * 1024) / PAGE_CACHE_SIZE;
#else
		unsigned long this_chunk = (2 * 1024 * 1024) / PAGE_CACHE_SIZE;
#endif /* CONFIG_AGGRESSIVE_READAHEAD */
		int err;
...
{
#ifdef CONFIG_AGGRESSIVE_READAHEAD
	return min(nr, (VM_MAX_READAHEAD * 1024) >> PAGE_CACHE_SHIFT);
#else
