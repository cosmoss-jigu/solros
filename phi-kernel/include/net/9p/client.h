...
struct p9_client {
	...
	struct p9_req_t *(*zc_rpc)(struct p9_client *c, int8_t type,
				   char *uidata, char *uodata,
				   int inlen, int olen, int in_hdrlen,
				   int kern_buf, const char *fmt, ...);
#ifdef CONFIG_9P_FS_BULK_PAGE_IO
    struct p9_req_t *(*zc_bulk_rpc)(struct p9_client *c, int8_t type,
				   struct page **pages, u32 pgcount, int len,
                   int in_hdrlen, const char *fmt, ...);
#endif
...
int p9_client_rdwr_size(struct p9_fid *fid, u32 count);
int p9_client_read(struct p9_fid *fid, char *data, char __user *udata,
							u64 offset, u32 count);
#ifdef CONFIG_9P_FS_BULK_PAGE_IO
int p9_client_bulk_read(struct p9_fid *fid, struct page **pages,
                        int pgcount, int p9_size, loff_t offset);
int p9_client_bulk_write(struct p9_fid *fid, struct page **pages,
			 int pgcount, int p9_size, loff_t offset);
#endif
