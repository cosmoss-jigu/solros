...
size_t ring_buffer_scif_secure_free_space(struct ring_buffer_scif_t *rbs, size_t n)
{
	return ring_buffer_secure_free_space(rbs->rb, n);
}
EXPORT_SYMBOL(ring_buffer_scif_secure_free_space);
