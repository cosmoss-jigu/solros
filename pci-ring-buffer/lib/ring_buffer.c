...
static inline
void rb_rmb_head_tail2(struct ring_buffer_t *rb)
{
	struct ring_buffer_t *rb_org;
...
static inline
void rb_wmb_tail2(struct ring_buffer_t *rb)
{
	struct ring_buffer_t *rb_org;
	volatile size_t __dummy;
...
static
void reap_ring_buffer_elms(struct ring_buffer_t *rb, size_t reap_size)
{
	/*
...
static
void reap_ring_buffer_elms_aggressively(struct ring_buffer_t *rb, size_t reap_size)
{
...
size_t ring_buffer_secure_free_space(struct ring_buffer_t *rb, size_t n)
{
	/* !!! WARNING !!!
...
EXPORT_SYMBOL(ring_buffer_secure_free_space);
...
start:
	...
	if (ring_buffer_secure_free_space(rb, rb->size) < req->__size) {
...
{
	static const unsigned short exist_bits =
		RING_BUFFER_ELM_STATUS_READY;
